...
export function SocialLinksSection() {
  return (
    <div className="flex flex-col sm:flex-row sm:items-center gap-5 text-sm font-medium text-muted-foreground w-full">
      ...
      <div className="flex items-center gap-3">
        {SOCIAL_LINKS.map((social) => {
          ...
          return (
            ...
            >
              <IconComponent className="w-[18px] h-[18px] text-muted-foreground group-hover:text-inherit transition-colors" />
            </a>
          );
        })}
      </div>
